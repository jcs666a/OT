...
<script>
	...
	function payChartporDist(llave) {
			...
			if (totalDistritos >=1){
				...
				$('#linearChart').html('<div style="border:solid 1px color:#cccccc; height:50px; width:500px; margin:0px auto; text-align:center; font-size:16px; color:#B40404; margin-top:20px;"><img src="images/warning_small.png" />No existen datos en este distrito.</div>');				
			}
...
<div style="margin:0px auto; font-family:Arial, Helvetica, sans-serif; margin:5px; line-height:30px; text-align:center; background-color:#fafafa; font-size:18px; color:#000000;">Filtro de Distritos<strong><?= $area;?></strong></div>
