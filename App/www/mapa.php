...
<!-- BEGIN HEAD -->
  <head>
	...
	<script type="text/javascript" src="js/mapaDin.js"></script> 
...
<!-- tecnologias  -->
    <script src="js/pinta_tecnologias.js"></script>
    <script src="js/pinta_pois.js"></script> 
    <script src="js/pinta_pois_All.js"></script>
    
<!-- TAG -->
      <link rel="stylesheet" type="text/css" href="js/jQuery-Tagit-master/css/tagit-stylish-yellow.css">
...
?>    
    ...
    <body>
		...
		<div id="header">
            ...
            <img src="images/logo_white.png" border="0" style="margin-top:5px; margin-left:20px;">
           <!-- el otro menu  <div id="menuPullerWiket"></div>-->
        </div>
  				...
  				<div class="titleMenu" id="menuJumper">
					<table style="width:100%;">
                    	<tr>
                            ...
                            <td style="text-align:right;"><img src="images/arrow_entra.png" align="absmiddle" border="0" style="cursor:pointer;" /></td>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
                </div>
									...
									<div style="margin-left:14px; display:none;" id="distritosText">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="distritosGeoTel" data-name="nameOfSelect" name="distritosGeoTel"  style="width:120px;"> <img src="images/btn_add.png" border="0" style="cursor:pointer; margin-bottom:1px;" align="absbottom" onClick="agregaDist();">
                                                </td>
                                            </tr> 
                                            <tr>
                                            	<td></td>
...
<!--                  <h3>Geograf&iacute;a</h3>
                ...
                <!--Menu de eventos en tiempo real 
		...
		<div id="menuWiket">
  				<div class="titleMenuWiket" id="menuJumperWiket">
					<table style="width:100%;">
                    	<tr>
                            <td><img src="images/arrow_entra_right.png" align="absmiddle" border="0" style="cursor:pointer;" /></td>
                ...
                <ul id="gallery">
                    <li id="live">
                        ...
                        <div style="text-align:center;"><img src="images/realtime.PNG" alt="Quejas en Tiempo Real" /></div>
                    </li>
    			</ul>                 
                        ...
                        <td>
                            <div>
                                <!--<table id="encabezadosActivos" style="background-color:#CCCCCC; padding:5px; float:left; width:100%;">
                                    <tr>
                                        <td style="width:45px; text-align:center;">Mostrar</td>
                                        <td style="width:120px;">Elemento</td>
                                ...
                                <ul style="margin:0px; padding:0px; width:100%;" id="encabezadosActivos">
                                    ...
                                    <li style="width:120px;" class="activoEnlaLista">Elemento</li>
                                    <li style="width:60px;" class="activoEnlaLista">Opciones</li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <div id="socketizable" style="visibility:hidden; min-width:400px;">
            <div class='titu' style="line-height:40px; min-width:400px; background-color:#336699; font-family:Arial, Helvetica, sans-serif; color:#FFFFFF; text-align:left; font-size:18px;"> <img src="images/move_icon.png" border="0" style="cursor:pointer; float:left; margin-right:7px; margin-left:10px; margin-top:10px;"> Heat-Map de necropsia por distrito, por &aacute;rea. <img src="images/closeBtnSmall.png" border="0" onClick="resizas();" style="cursor:pointer; float:right; margin-right:7px; margin-top:7px;" align="absmiddle"></div>
