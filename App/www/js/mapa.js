...
/***************************  FUNCION QUE AGREGA LOS ELEMENTOS ACTIVOS A LA LISTA SOBRE EL MAPA CON LAS OPCIONES POR REENGLON *******************************/	
		...
		function agregaActivos(distrito, llave, i, tipo, are, divisionId, tipoUser, elemento){
			...
			if (tipoUser==1){ //// SI ES USUARIO COMERCIAL
				...
				$("#"+elemento).append('<li style=" text-align:center; background-color:rgba(235,248,204,0.8);" class="activoEnlaLista"><img src="images/ic_settings_input_antenna_black_18dp.png" title="Tecnologías" border="0" style="cursor:pointer;" id="comic_'+llave+'" align="absbottom" onclick="dialogModel(\''+llave+'\', \''+are+'\', \'tec\');" /></li>');
				$("#"+elemento).append('<li style=" text-align:center; background-color:rgba(235,248,204,0.8);" class="activoEnlaLista">&nbsp;&nbsp;<img src="images/ic_assignment_ind_black_18dp.png" title="Fielders" border="0" style="cursor:pointer;" id="pye_'+llave+'" align="absbottom" onclick="detalleSlideTecnos(\''+llave+'\', \''+are+'\');" /></li>');
				$("#"+elemento).append('<li style=" text-align:center; background-color:rgba(235,248,204,0.8);" class="activoEnlaLista">&nbsp;&nbsp;<img src="images/ic_accessibility_black_18dp.png" title="Clientes" border="0" style="cursor:pointer;" id="poi_'+llave+'" align="absbottom" onclick="dialogModel(\''+llave+'\', \''+are+'\', \'poi\');" /></li>');
			}
