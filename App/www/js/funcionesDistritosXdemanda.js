	...
	function abreWidgetDistritos(llave){
		...
		if ( $("#tumbnailDistritsTotales").length <= 0 ) {
						$("#gallery").append('<li id="tumbnailDistritsTotales">'+
                        		'<div style="background-color:#E6E6E6; text-align:left;"><img src="images/widgetIcon.png" style="cursor:pointer; float:rigth; margin-top:4px; margin-left:5px; margin-bottom:3px;" align="absbottom"  onclick="abreWidgetDistritos(\''+llave+'\');" /> &nbsp;&nbsp;&nbsp; Distritos por &aacute;rea </div>'+
                        		'<div style="text-align:center;"><img src="images/districts.png" alt="Distritos por &aacute;rea" /></div>'+
                    		'</li>');
		}
