    ...
    $(document).ready(function () {
        ...
        function createDetail(masterChart) {
            ...
            detailChart = $('#detail-container').highcharts({
                ...
                title: {
                    text: 'Historico de bajas de usuarios'
                },
                subtitle: {
                    text: 'Selecciona un área desplazando el cursor'
                },
                xAxis: {
                    type: 'datetime'
                },
                ...
                tooltip: {
                    formatter: function () {
                        ...
                        return '<b>' + point.series.name + '</b><br/>' +
                            Highcharts.dateFormat('%A %B %e %Y', this.x) + ':<br/>'+ Highcharts.numberFormat(point.y, 2) + ' Porciento de cancelaciones';
                    },
                    shared: true
                },
                legend: {
