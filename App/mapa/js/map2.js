				...
				//map.data.addGeoJson(dataCartografica[llave]);
						...
						$.ajax({
							...
							success: function(html){
								...
								/* Tooltip distrito '<div style="background-color:#CCCCCC; line-height:20px; text-align:center;"><b>'+distritoDsc+'</b></div>'+													'<table style="width:300px; font-family:Arial, Helvetica, sans-serif; font-size:10px;">'+
						  '<tr><td style="text-align:right; background-color:#F2F2F2;">Tecnlogía:</td><td style="text-align:left;">'+domicilio+'</td></tr>'+
						  '<tr><td style="text-align:right; background-color:#F2F2F2;">Velocidad Maxima:</td><td style="text-align:left;">'+telefono+'</td></tr>'+
						  '<tr><td style="text-align:right; background-color:#F2F2F2;">PDM:</td><td style="text-align:left;">'+perfil+'</td></tr>'+
...
/***************************  FUNCION QUE AGREGA LOS ELEMENTOS ACTIVOS A LA LISTA SOBRE EL MAPA CON LAS OPCIONES POR REENGLON *******************************/	
		...
		function agregaActivos(distrito, llave, i, tipo, are, divisionId, tipoUser, elemento){
			...
			if (tipoUser==1){ //// SI ES USUARIO COMERCIAL
				...
				$("#"+elemento).append('<li style="width:80px; text-align:center; background-color:rgba(235,248,204,0.8);" class="activoEnlaLista"><img src="images/necrop_icon.png" border="0" style="cursor:pointer;" id="comic_'+llave+'" align="absbottom" onclick="dialogModel(\''+llave+'\', \''+are+'\');" /></li>');
				...
				$("#"+elemento).append('<li style=" text-align:center; background-color:rgba(235,248,204,0.8);" title="Tecnologías" class="activoEnlaLista"><img src="images/ic_settings_input_antenna_black_18dp.png" border="0" style="cursor:pointer;" id="comic_'+llave+'" align="absbottom" onclick="dialogModel(\''+llave+'\', \''+are+'\', \'tec\');" /></li>');
				$("#"+elemento).append('<li style=" text-align:center; background-color:rgba(235,248,204,0.8);" title="Fielders" class="activoEnlaLista">&nbsp;&nbsp;<img src="images/ic_assignment_ind_black_18dp.png" border="0" style="cursor:pointer;" id="pye_'+llave+'" align="absbottom" onclick="detalleSlideTecnos(\''+llave+'\', \''+are+'\');" /></li>');
				$("#"+elemento).append('<li style=" text-align:center; background-color:rgba(235,248,204,0.8);" title="Clientes" class="activoEnlaLista">&nbsp;&nbsp;<img src="images/ic_accessibility_black_18dp.png" border="0" style="cursor:pointer;" id="poi_'+llave+'" align="absbottom" onclick="dialogModel(\''+llave+'\', \''+are+'\', \'poi\');" /></li>');
			}
		...
		function dialogModel(llave,are,tipoComic){
			...
			if (tipoUser==1){
				...
				if (tipoComic=="tec"){
						...
						$.ajax({
							type: "POST",
							url: "ajax/contenidoComicPOI.php",
							data: "llave=" + llave +  "&are=" + are,
							cache: false, 
							success: function(html){
								$("#tecnoDialog").html(html);
...
/********FUNCIONES PARA MOSTRAR LOS SLIDES DE LAS GRAFICAS ********************************************/
		...
		function detalleSlide(distrito, llave, are, tipo, div ){
			...
			$("#graphSlide").html("<div style='width:100%; text-align:center; margin-top:300px;'><img src='images/ajax-loader.gif' style='margin:0px auto;'></div>");
			$.ajax({
				type: "POST",
...
/***********************Funcion para agregar distritos*****************************************/		
	function agregaDist(){
