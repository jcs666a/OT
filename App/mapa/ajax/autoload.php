			...
			?>
						...
						if (dataTecnologica['<?php echo $llave; ?>'].tecnologia[idt].markers.length > 0){
							...
							$("#tecnoCheck-<?php echo $distrito;?>").append("<li><input type='checkbox'  id='check-"+tecnos[i].id+"' value='"+tecnos[i].id+"' class='opcTeno_"+tecnos[i].id+"' onchange=\"discart('"+tecnos[i].id+"','<?php echo $are; ?>','<?php echo $llave; ?>','<?php echo $distrito; ?>',this);\" checked>  <label  for='check-"+tecnos[i].id+"' style='color:#"+colorLe+";'>"+tecnos[i].descripcion+"</label>  <span id='wigTeno_"+tecnos[i].id+"'></span></li>");
						}
						if (dataTecnologica['<?php echo $llave; ?>'].tecnologia[idt].markers.length > 0){
							if (activos.indexOf("<?php echo $llave; ?>-tenoid-"+tecnos[i].id) > 0){															
						...
						$("#tecnoCheck-<?php echo $llave;?>").append("<li><input type='checkbox' id='check-"+tecnos[i].id+"' value='"+tecnos[i].id+"' class='opcTeno_"+tecnos[i].id+"' onchange=\"discart('"+tecnos[i].id+"','<?php echo $are; ?>','<?php echo $llave; ?>',' ',this);\" checked>  <label for='check-"+tecnos[i].id+"' style='color:#"+colorLe+";'>"+tecnos[i].descripcion+"</label>  <span id='wigTeno_"+tecnos[i].id+"'></span></li>");
					}	
...
<div id="tecnoCheck-'+distrito+'"></div>