...
function muestraUsuarios(){
	...
	limpiaTablaG();
	$('#ctable h2').addClass('campin').html('Usuarios <a class="newUser"></a>').show();
	...
	if(mstraUsrTi.k==''){
		...
		$('#ctable h2').html('<a class="newUser"></a><a href="#" class="bakUsers">Regresar</a>Usuarios del Lider '+mstraUsrTi.n+
		...
		$('#ctable h2').html('<a class="newUser"></a><a href="#" class="bakUsers">Regresar</a>Usuarios del Director '+mstraUsrTi.n+
			'<span class="sub">'+mstraUsrTi.c+'</span>').show();
...
function muestraCampanas(){
	tablaFielders.destroy();
	limpiaTablaG();
	$('#ctable h2').addClass('campin').html('<a class="relCamps"></a><a class="newCamps"></a>').show();
	if(Rol=='Lider Promotor')
		$('#tablaFielders thead').append('<tr>'+
			'<th>Título</th>'+
			'<th>Códigos</th>'+
...
$(document).on("click","h2 .newCamps",function(event){event.preventDefault();nuevaCampana();});
$(document).on("click","h2 .newUser",function(event){event.preventDefault();nuevoUsuario();});
